...
class SolicitudModel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	...
	/**
	 * set value for FechaAbonoDiario 
	 *
	 * type:DATE,size:10,default:null,nullable
	 *
	 * @param mixed $FechaAbonoDiario
	 * @return SolicitudModel
	 */
	public function &setFechaAbonoDiario($FechaAbonoDiario) {
		$this->notifyChanged(self::FIELD_FECHAABONODIARIO,$this->FechaAbonoDiario,$FechaAbonoDiario);
		$this->FechaAbonoDiario=$FechaAbonoDiario;
		return $this;
	}

	/**
	 * get value for FechaAbonoDiario 
	 *
	 * type:DATE,size:10,default:null,nullable
	 *
	 * @return mixed
	 */
	public function getFechaAbonoDiario() {
		return $this->FechaAbonoDiario;
	}
	...
	public function &setAnulado($Anulado) {
		$this->notifyChanged(self::FIELD_ANULADO,$this->Anulado,$Anulado);
