...
class UsuarioModel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	...
	const SQL_INSERT='INSERT INTO `usuario` (`idUsuario`,`NombreUsuario`,`Password`,`TipoUsuario`,`FechaAlta`,`FechaBaja`) VALUES (?,?,?,?,?,?)';
	...
	const FIELD_TIPOUSUARIO=1740763770;
	const FIELD_FECHAALTA=1569699349;
	const FIELD_FECHABAJA=1569718259;
	private static $PRIMARY_KEYS=array(self::FIELD_IDUSUARIO);
	private static $AUTOINCREMENT_FIELDS=array(self::FIELD_IDUSUARIO);
	private static $FIELD_NAMES=array(
		self::FIELD_IDUSUARIO=>'idUsuario',
		self::FIELD_NOMBREUSUARIO=>'NombreUsuario',
		self::FIELD_PASSWORD=>'Password',
		self::FIELD_TIPOUSUARIO=>'TipoUsuario',
	...
	private static $PROPERTY_TYPES=array(
		self::FIELD_IDUSUARIO=>Db2PhpEntity::PHP_TYPE_INT,
		self::FIELD_NOMBREUSUARIO=>Db2PhpEntity::PHP_TYPE_STRING,
		self::FIELD_PASSWORD=>Db2PhpEntity::PHP_TYPE_STRING,
		self::FIELD_TIPOUSUARIO=>Db2PhpEntity::PHP_TYPE_INT,
		self::FIELD_FECHAALTA=>Db2PhpEntity::PHP_TYPE_STRING,
		self::FIELD_FECHABAJA=>Db2PhpEntity::PHP_TYPE_STRING);
	private static $FIELD_TYPES=array(
		self::FIELD_IDUSUARIO=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false),
		self::FIELD_NOMBREUSUARIO=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,45,0,true),
		self::FIELD_PASSWORD=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,45,0,true),
		self::FIELD_TIPOUSUARIO=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,true),
	...
	private static $DEFAULT_VALUES=array(
		self::FIELD_IDUSUARIO=>null,
		self::FIELD_NOMBREUSUARIO=>null,
		self::FIELD_PASSWORD=>null,
		self::FIELD_TIPOUSUARIO=>null,
	...
	public function &setIdUsuario($idUsuario) {
		$this->notifyChanged(self::FIELD_IDUSUARIO,$this->idUsuario,$idUsuario);
	...
	public function &setNombreUsuario($NombreUsuario) {
		$this->notifyChanged(self::FIELD_NOMBREUSUARIO,$this->NombreUsuario,$NombreUsuario);
		$this->NombreUsuario=$NombreUsuario;
		return $this;
	}

	/**
	 * get value for NombreUsuario 
	 *
	 * type:VARCHAR,size:45,default:null,nullable
	 *
	 * @return mixed
	...
	public function &setTipoUsuario($TipoUsuario) {
		$this->notifyChanged(self::FIELD_TIPOUSUARIO,$this->TipoUsuario,$TipoUsuario);
		$this->TipoUsuario=$TipoUsuario;
		return $this;
	}

	/**
	 * get value for TipoUsuario 
	 *
	 * type:INT,size:10,default:null,nullable
	 *
	 * @return mixed
	...
	public function toArray() {
		return array(
			...
			self::FIELD_NOMBREUSUARIO=>$this->getNombreUsuario(),
			self::FIELD_PASSWORD=>$this->getPassword(),
			self::FIELD_TIPOUSUARIO=>$this->getTipoUsuario(),
	...
	public function assignByHash($result) {
		...
		$this->setNombreUsuario($result['NombreUsuario']);
		$this->setPassword($result['Password']);
		$this->setTipoUsuario($result['TipoUsuario']);
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(2,$this->getNombreUsuario());
		$stmt->bindValue(3,$this->getPassword());
		$stmt->bindValue(4,$this->getTipoUsuario());
	...
	public function insertIntoDatabase(PDO $db) {
		if (null===$this->getIdUsuario()) {
			...
			$stmt->bindValue(1,$this->getNombreUsuario());
			$stmt->bindValue(2,$this->getPassword());
			$stmt->bindValue(3,$this->getTipoUsuario());
	...
	public function updateToDatabase(PDO $db) {
		...
		$this->bindValues($stmt);
		$stmt->bindValue(7,$this->getIdUsuario());
		$affected=$stmt->execute();
		if (false===$affected) {
			$stmt->closeCursor();
			throw new Exception($stmt->errorCode() . ':' . var_export($stmt->errorInfo(), true), 0);
