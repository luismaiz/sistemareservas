                            ...
                            <fieldset>
                                <div class="form-group has-success has-feedback">
                                    <div class="col-md-5 col-sm-5 input-group-lg">
                                        ...
                                        <input type="text" class="control-label" id="NombreActividad" ng-model="clase.idActividad"/>
                                    </div>
                                    <div class="col-md-5 col-sm-5 input-group-lg">
                                        <label class="control-label" > Id Sala </label>
                                        <input type="text" class="control-label" id="idSala" ng-model="clase.idSala"/>
                                        <br />
                                    </div>
                                    <br />
                                    <div class="col-md-5 col-sm-5 input-group-lg">
                                        <label class="control-label" >Fecha Inicio</label>
                                        <input type="text" class="control-label" id="FechaInicio" ng-model="clase.FechaInicio"/>
                                    </div>
                                    <div class="col-md-5 col-sm-5 input-group-lg">
                                        <label class="control-label" >Hora Inicio</label>
                                        <input type="text" class="control-label" id="HoraInicio" ng-model="clase.HoraInicio"/>
                                    </div>
                                    <br />                            
                                    <div class="col-md-2 col-sm-2 input-group-lg">
                                        <label class="control-label" >Fecha Fin</label>
                                        <input type="text" class="control-label" id="FechaFin" ng-model="clase.FechaFin"/>
                                    </div>
                                    <div class="col-md-5 col-sm-5 input-group-lg">
                                        <label class="control-label" >Hora Fin</label>
                                        <input type="text" class="control-label" id="HoraFin" ng-model="clase.HoraFin"/>
                                    </div>
                                    <div class="col-md-5 col-sm-5 input-group-lg">
                                        <label class="control-label" >Ocupacion</label>                                                                                
                                        <input ng-model="clase.Ocupacion" type="color" width="20" height="20" id="Ocupacion" name="Ocupacion" disabled/>
                                    </div>
                                </div>
