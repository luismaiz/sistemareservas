                                ...
                                <fieldset>
                                    <div class="form-group has-success has-feedback">
                                        <div class="form-group has-success has-feedback">
                                            ...
                                            <div class="col-md-5 col-sm-5 input-group-lg">
                                                <label class="control-label" >Fecha nacimiento</label><input type="text" name="FechaNacimiento" ng-model="s.FechaNacimiento" datepicker class="form-control" id="FechaNacimiento" ng-change="esMenor(s.FechaNacimiento);" ng-pattern="/^(198\d|[2-9]\d{3})\-(0?[1-9]|1[012])\-(0?[1-9]|[12][0-9]|3[01])$/" readonly required placeholder="yyyy-mm-dd">
