...
//                $scope.estado = JSON.parse(Ajax.responseText).estado;
//                
//                $scope.numerosolicitudes = JSON.parse(Ajax.responseText).numerosolicitudes;
//                                
//                if ($scope.estado === 'correcto')
//                {
...
<div class=" row" ng-app="BusquedaSolicitudes">
    <div ng_controller="CargaSolicitudes">
        ...
        <div class="col-md-6 col-sm-3 col-xs-6">
            <a  id="enlace" data-toggle="tooltip" title="{{numerosolicitudes}} nuevas solicitudes." class="well top-block" href="Reservas.php">
