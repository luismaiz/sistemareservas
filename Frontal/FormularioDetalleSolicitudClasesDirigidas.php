                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active" id="datospersonales">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input ng-model="clasesdirigidas.Localizador"  type="text" class="input-sm col-lg-6 col-md-6 col-sm-8 col-xs-12" name="localizador" id="Localizador" required >
                                ...
                                <input ng-model="clasesdirigidas.Nombre"  type="text" class="input-sm col-lg-6 col-md-6 col-sm-8 col-xs-12" name="nombre" id="Nombre" required >
                                ...
                                <input ng-model="clasesdirigidas.Apellidos" type="text" class="input-sm col-lg-8 col-md-8 col-sm-10 col-xs-12"  name="apellidos" id="Apellidos" required>
                                ...
                                <input ng-model="clasesdirigidas.FechaNacimiento" type="text" class="input-sm col-md-2 col-sm-4 col-xs-8" name="FechaNacimiento" id="FechaNacimiento" ng-pattern="/^(0?[1-9]|[12][0-9]|3[01])\-(0?[1-9]|1[012])\-(199\d|[2-9]\d{3})$/" required>
                                ...
                                <input ng-model="clasesdirigidas.DNI" type="text" class="input-sm col-lg-2 col-md-4 col-sm-6 col-xs-12" name="dni" id="Dni" required ng-pattern='/^\d{7,8}(-?[a-z])?$/i'>
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                     <label class="control-label" >Mujer</label>  <input type="radio"  name="Sexo" value="M"  id="Sexo"/>
                                     <label class="control-label" >Hombre</label>  <input type="radio" name="Sexo" value="H" checked="checked" id="Sexo"/>
                                </div>
                    </div>
                    <div class="tab-pane" id="direccion">
                        <h3></h3>
                                ...
                                <input ng-model="clasesdirigidas.Direccion"  type="text" class="input-sm col-lg-8 col-md-8 col-sm-10 col-xs-12" name="direccion" id="Direccion" required >
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input ng-model="clasesdirigidas.Localidad"  type="text" class="input-sm col-lg-6 col-md-3 col-sm-4 col-xs-12" name="localidad" id="Localidad" required >
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input ng-model="clasesdirigidas.Provincia"  type="text" class="input-sm col-lg-6 col-md-3 col-sm-4 col-xs-12" name="provincia" id="Provincia" required >
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input ng-model="clasesdirigidas.CodigoPostal"  type="text" class="input-sm col-lg-1 col-md-1 col-sm-2 col-xs-3" name="codigopostal" id="CodigoPostal" required >
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">                                
                                ...
                                <input ng-model="clasesdirigidas.Email" type="email" class="input-sm col-lg-6 col-md-6 col-sm-8 col-xs-12" name="mail" id="Mail" required >
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input ng-model="clasesdirigidas.Telefono1"  type="text" class="input-sm col-lg-1 col-md-2 col-sm-3 col-xs-3" maxlength="9" name="telefono1" id="Telefono1" required >
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input ng-model="clasesdirigidas.Telefono1"  type="text" class="input-sm col-lg-1 col-md-2 col-sm-3 col-xs-3" name="telefono2" id="Telefono2" required >
                    ...
                    <div class="tab-pane" id="datosbancarios" ng-repeat="dato in datosbancarios">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input ng-model="dato.Titular"  type="text" class="input-sm col-lg-6 col-md-6 col-sm-8 col-xs-12" name="titular" id="Titular" required >
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <fieldset> 
                            <label class="control-label col-lg-2 col-md-12 col-sm-12 col-xs-12" >Cuenta Bancaria</label>
                                <label class="control-label col-lg-2 col-md-12 col-sm-12 col-xs-12" >Control IBAN</label>
                                <input ng-model="dato.IBAN"  disabled="true" type="text" maxlength="4" class="input-sm col-lg-1 col-md-1 col-sm-2 col-xs-3" name="iban" id="Iban" required >
                                <label class="control-label col-lg-2 col-md-12 col-sm-12 col-xs-12" >Entidad</label>
                                <input ng-model="dato.Entidad"  type="text" maxlength="4" class="input-sm col-lg-1 col-md-1 col-sm-2 col-xs-3" name="entidad" id="Entidad" required ng-pattern="/^\d+$/" >
                                <label class="control-label col-lg-2 col-md-12 col-sm-12 col-xs-12" >Oficina</label>
                                <input ng-model="dato.Oficina"  type="text" maxlength="4" class="input-sm col-lg-1 col-md-1 col-sm-2 col-xs-3" name="oficina" id="Oficina" required ng-pattern="/^\d+$/">
                                <label class="control-label col-lg-2 col-md-12 col-sm-12 col-xs-12" >Digito Control</label>
                                <input ng-model="dato.DigitoControl"  type="text" maxlength="2" class="input-sm col-lg-1 col-md-1 col-sm-1 col-xs-2" name="digito" id="Digito" required ng-pattern="/^\d+$/">
                                <label class="control-label col-lg-2 col-md-12 col-sm-12 col-xs-12" >Número de cuenta</label>
                                <input ng-model="dato.Cuenta"  type="text" maxlength="10" class="input-sm col-lg-4 col-md-4 col-sm-6 col-xs-12" name="cuenta" id="Cuenta" required ng-pattern="/^\d+$/">
                                <span style="color:red" ng-show="formulario.titular.$dirty && formulario.titular.$invalid">
