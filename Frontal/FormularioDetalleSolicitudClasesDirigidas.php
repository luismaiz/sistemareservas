                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active" id="datossolicitud">
                        ...
                        <div class="form-group col-md-12">
                                ...
                                <input ng-model="clasesdirigidas.FechaSolicitud" type="date" class="input-sm col-md-2 col-sm-4 col-xs-4" name="FechaSolicitud" id="FechaSolicitud" ng-pattern="/^(0?[1-9]|[12][0-9]|3[01])\-(0?[1-9]|1[012])\-(199\d|[2-9]\d{3})$/" required>
