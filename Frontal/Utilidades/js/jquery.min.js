...
set:function(a,b,c){
    ...
    else if(n.isEmptyObject(f))n.extend(this.cache[e],b);else for(d in b)f[d]=b[d];return f
    },
get:function(a,b){
...
d?n.event.trigger(e,null,b):n.event.dispatch.call(b,e),e.isDefaultPrevented()&&c.preventDefault()
    ...
    on:function(a,b,c,d,e){
        ...
        if("object"==typeof a){
            ...
            for(g in a)this.on(g,b,c,a[g],e);return this
            }
...
function ob(a,b){
    ...
    buildFragment:function(a,b,c,d){
        for(var e,f,g,h,i,j,k=b.createDocumentFragment(),l=[],m=0,o=a.length;o>m;m++)if(e=a[m],e||0===e)if("object"===n.type(e))n.merge(l,e.nodeType?[e]:e);
            ...
            }else l.push(b.createTextNode(e));k.textContent="",m=0;
...
function Sb(){
    ...
    for(d in b)if(e=b[d],Nb.exec(e)){
        ...
        }else j=void 0;if(n.isEmptyObject(m))"inline"===("none"===j?tb(a.nodeName):j)&&(o.display=j);
    else{
...
for(Wb(k,j.opts.specialEasing);g>f;f++)if(d=Qb[f].call(j,a,k,j.opts))return d;return n.map(k,Ub,j),n.isFunction(j.opts.start)&&j.opts.start.call(a,j),n.fx.timer(n.extend(i,{
    elem:a,
    anim:j,
    queue:j.opts.queue
...
a.ActiveXObject&&n(a).on("unload",function(){
    ...
    return k.cors||Fc&&!a.crossDomain?{
        send:function(c,d){
            ...
            for(e in c)f.setRequestHeader(e,c[e]);b=function(a){
                return function(){
