...
<script>
    ...
    function obtenerTiposTarifa(){
        ...
        for(i=0; i<Clase.tiposTarifa.length; i++){		
            ...
            contenido = contenido + '<td class="center"><a href="FormularioDetalleTarifa.php?idTipoTarifa=' + Clase.tiposTarifa[i].idTipoTarifa + '" class="btn btn-info"><i class="glyphicon glyphicon-edit icon-white"></i>Detalle</a></td>';
            contenido = contenido + '</tr>';
        }
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="box btn-primary" type="button" value="Buscar" onclick="obtenerTiposTarifa()"/>
                            </div>
                        </div>
